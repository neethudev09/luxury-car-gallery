...
export const brands: Brand[] = [
  ...
  { name: "Lamborghini", slug: "lamborghini", available: 4, sold: 0 },
  { name: "Mercedes-Benz", slug: "mercedes-benz", available: 5, sold: 0 },
...
const base: CarBase[] = [
  ...
  {
    slug: "bmw-x6m-competition-900-hp-2022",
    title: "BMW X6M COMPETITION 900 HP",
    brand: "BMW",
    brandSlug: "bmw",
    model: "X6M COMPETITION 900 HP",
    year: 2022,
    price: 330000,
    mileage: 40850,
    fuel: "Petrol",
  ...
  },
  {
    ...
    sold: false,
    description:
      "Ferrari 488 PISTA (2020). European spec, finished in Blue over Grey. 43,421 km. Presented by Luxury Car Gallery, Dubai.",
    features: fmtFeatures,
  },
  {
  ...
  },
  {
    ...
    bodyType: "Coupe",
    exteriorColour: "Black",
    interiorColour: "mix grey leather and alcantara/yellow stitching",
    image: carPlaceholder,
    featured: true,
    sold: false,
    description:
      "Lamborghini Temerario (2026). European spec, finished in black over mix grey leather and alcantara/yellow stitching. 170 km. Presented by Luxury Car Gallery, Dubai.",
    features: fmtFeatures,
  },
  {
  ...
  {
    slug: "mercedes-benz-sprinter-vip-executive-conversion-2023",
    title: "Mercedes-Benz Sprinter VIP Executive Conversion",
    brand: "Mercedes-Benz",
    brandSlug: "mercedes-benz",
    model: "Sprinter VIP Executive Conversion",
    year: 2023,
    price: 650000,
    mileage: 3300,
    fuel: "Petrol",
    ...
    interiorColour: "Cream/Black",
    image: carPlaceholder,
    featured: false,
    sold: false,
    description:
      "Mercedes-Benz Sprinter VIP Executive Conversion (2023). European spec, finished in Black Metallic over Cream/Black. 3,300 km. Presented by Luxury Car Gallery, Dubai.",
    features: fmtFeatures,
  },
  {
  ...
  {
    slug: "mercedes-benz-g63-mansory-kit-2024",
    title: "Mercedes-Benz G63 Mansory kit",
    brand: "Mercedes-Benz",
    brandSlug: "mercedes-benz",
    model: "G63 Mansory kit",
    year: 2024,
    price: 850000,
    mileage: 11500,
    fuel: "Petrol",
    transmission: "Automatic",
    bodyType: "SUV",
    exteriorColour: "Black & Tiffany Blue",
    interiorColour: "tiffany blue",
    image: carPlaceholder,
    featured: false,
    sold: false,
    description:
      "Mercedes-Benz G63 Mansory kit (2024). European spec, finished in black & tiffany blue over tiffany blue. 11,500 km. Presented by Luxury Car Gallery, Dubai.",
    features: fmtFeatures,
  },
  {
  ...
  },
  {
    ...
    sold: false,
    description:
      "Mercedes-Benz G700 (2021). European spec, finished in Black over Beige. 70,400 km. Presented by Luxury Car Gallery, Dubai.",
    features: fmtFeatures,
  },
];
...
export const cars: Car[] = base.map((c) => {
  ...
  const hero = gallery && gallery[heroIdx] ? gallery[heroIdx] : gallery?.[0];
