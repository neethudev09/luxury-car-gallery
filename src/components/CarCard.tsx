...
const IMAGE_FALLBACK =
  ...
  encodeURIComponent(
    `<svg xmlns='http://www.w3.org/2000/svg' width='1024' height='768'><rect width='100%' height='100%' fill='#15161a'/><text x='50%' y='50%' fill='#8f8f8f' font-family='Arial, sans-serif' font-size='30' text-anchor='middle'>Image unavailable</text></svg>`,
  );
